...
Quick-reference index organizing all species documentation across 6 taxonomies.
...
The original architects of the System and Consortium.

| # | Species | Classification | Primary Faction |
|---|---------|----------------|-----------------|
| 1 | Velthrani | Hostile | Old Guard |
| 2 | Harken | Hostile | Old Guard |
| 3 | Keth'oran | Hostile | Old Guard |
| 4 | Thal'vex | Hostile | Old Guard |
| 5 | Soleth | Sympathetic | Old Guard (dissenting) |
| 6 | Vaelthrim | Neutral | Old Guard (reform) |
| 7 | Vor'enthal | Sympathetic | Old Guard (diplomatic) |
| 8 | Tharaxim | Neutral | Old Guard (minimal) |
| 9 | Nethyrim | Neutral | Old Guard (sporadic) |
| 10 | Morphex | Wildcard | None |
| 11 | Dyathi | Sympathetic | Old Guard |
| 12 | Axiom | Wildcard | None |

### Non-Founding Species

| Species | Tier | Consortium Status |
|---------|------|-------------------|
| Humans | Major | Entertainment Asset |
| Kindari | Major | Observer (Non-voting) |
...
Primary coalition of founding species.

| Species | Role | Notes |
|---------|------|-------|
| Velthrani | Core | Leading traditionalist voice |
| Harken | Core | Hunting partnerships |
| Keth'oran | Core | Betting market control |
| Thal'vex | Core | Broadcast infrastructure |
| Soleth | Dissenting | Frequently votes against bloc |
| Vaelthrim | Reform caucus | Advocates internal change |
| Vor'enthal | Diplomatic | Mediates internal conflicts |
| Tharaxim | Minimal | Rarely participates |
| Nethyrim | Sporadic | Inconsistent attendance |
| Dyathi | Relationship-focused | Votes with relationships |

### The Liberation Collective

Contestant-rights advocacy faction.

| Species | Relationship | Notes |
|---------|--------------|-------|
| Kindari | Primary member | Lead advocates |
| Soleth | Secondary supporter | Financial backing |
| Vaelthrim | Philosophical ally | Limited formal support |
| Dyathi | Secondary alignment | Welfare-focused |

### Independent / No Faction

| Species | Reason |
|---------|--------|
| Morphex | Faction alignment contradicts nature |
...
|---------|------|----------------|
| Velthrani | Founder | Contemptuous; views humans as vermin |
...
|---------|------|--------------|
| Kindari | Major | Active advocacy; direct assistance |
...
|---------|------|---------|
| Velthrani | Founder | Reptilian |
| Harken | Founder | Mammalian predator |
| Kindari | Major | Insectoid (moth) |
| Vor'enthal | Founder | Humanoid (tall) |
...
Water-adapted biology.

| Species | Tier | Notes |
|---------|------|-------|
| Soleth | Founder | Deep-sea adapted |

### Dimensional

Non-standard existence. See: [background/energy-based.md](background/energy-based.md)
...
**Hostile Founders**: Velthrani, Harken, Keth'oran, Thal'vex
**Sympathetic Founders**: Soleth, Vor'enthal, Dyathi
**Neutral Founders**: Vaelthrim, Tharaxim, Nethyrim
**Wildcard Founders**: Morphex, Axiom

**Human Allies**: Kindari (active), Soleth (covert), Vor'enthal (diplomatic)
**Human Enemies**: Velthrani (primary), Harken (predatory), Keth'oran (exploitative)

**Consortium Power Blocs**:
- Old Guard (12 founders, varying cohesion)
- Liberation Collective (contestant rights)
- Commercial Bloc (Thex Collective)
- Academic Bloc (Quorathi)
